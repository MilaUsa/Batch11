...
public class ObjectAndMethod {
    /*
    IQ: 1.(Facebook) What is object? And tell me about its methods?(2-3)
    Object is blueprint or presentation of the class.
    - there are many methods but I used
    #.equals-> which is comparison
    #.Hashcode--> memory location of the data
    #.toString--> it shows the all the variables in a string mode.

    2. what is difference between object and class?
    object is a presentation of the class.
    class is a  blue print/template of the object.
    object you can create as many as you want to have
    class one class
    object is declared with new keyword
    class declared class keyword

    3. How do you initialize the instance variables?
    There are different ways to initaliaze the instance variables. I mostly used
    Constructor
    method
    create an object
    directly assign it
...
Create 2 objects of the groceryStore into the GroceryStoreTest(main method inside
houstonStore
seattleStore
...
For the Houston Store: IN TEST CLASS
...
**TASK 6:
After the GroceryStore Class to a constructor that will take
information
