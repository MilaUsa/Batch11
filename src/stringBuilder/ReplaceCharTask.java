...
public class ReplaceCharTask {
    // create a method that will take StringBuilder Array as a parameter this method
    //will replace middle char of each element with '*' from the array if the length of the element is odd number
